...
public class SchoolManagementDemo {
    ...
    public static void main(String[] args) {
        ...
        institution.listAllStudents();
        
        // remover os alunos 3, 8 e 9 da instituição
        institution.removeAluno(aluno8);
        institution.removeAluno(aluno9);
        institution.removeAluno(aluno3);
        ...
        // remover professor 1 e 5 da instituição
        institution.removeTeacher(teacher1);
        institution.removeTeacher(teacher5);
        ...
        // listar todos os funcionários da instituição
        institution.listAllFuncionario();
        
        // remover os funcionários 4, 8 e 10 da instituição
        institution.removeFuncionario(funcionario4);
        institution.removeFuncionario(funcionario8);
        institution.removeFuncionario(funcionario10);
